    ...
    <Flex direction="column" gap="6">
        ...
        {tier.map(({ id, label, value }) => (
          <Card
            ...
            style={{
              cursor: "pointer",
              border:
                selectedTier === id ? "2px solid var(--accent-9)" : undefined,
            }}
      ...
      <Card size="2">
        <Flex direction="column" gap="2">
          ...
          <Text size="2">• 주황, 초록: V0-V2 수준의 초급 코스</Text>
          <Text size="2">• 파랑, 보라: V3-V4 수준의 중급 코스</Text>
          <Text size="2">• 빨강: V5 이상의 고급 코스</Text>
        </Flex>
      </Card>
